...
const Liquidacion = () => {
  ...
  return (
    <View>
      ...
      <TextInput style={styles.inputs} onChangeText={setNombre} />
      <Text style={styles.text}>Ingrese su salario por mes</Text>
      <TextInput style={styles.inputs} onChangeText={setSalario} />
      <Text>
        {nombre} su salario anual es de:{result.toString()}
      </Text>
    </View>
  );
};
